...
## Code to read in Activity labels and Feature data into lists to be used as labels and indexes when processing the training and test data
...
## Code to Load dataset and labels for the data used for training purposes
...
## Code to Load dataset and labels for the data used for testing purposes 
